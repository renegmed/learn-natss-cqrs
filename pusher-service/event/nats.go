...
import (
	...
	"github.com/renegmed/microserv-cqrs-natss/pusher-service/schema"
...
// Here, an intermediate channel is created to transform messages into appropriate type.
func (e *NatsEventStore) SubscribeMeowCreated() (<-chan MeowCreatedMessage, error) {
	...
	return (<-chan MeowCreatedMessage)(e.meowCreatedChan), nil // transform bidirectional channel into one direction channel
}
